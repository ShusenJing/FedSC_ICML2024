...
def knn_monitor(net, memory_data_loader, test_data_loader, k=200, t=0.1, classes =10, hide_progress=False, device=None):
    net.eval()
...
#         test_bar = tqdm(test_data_loader, desc='kNN', disable=hide_progress)
        for data, target in test_data_loader:
            ...
            pred_labels = knn_predict(feature, feature_bank, feature_labels, classes, k, t, device)
